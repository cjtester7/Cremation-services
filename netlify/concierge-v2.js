 ...
 * Version: 2.0
 * CR005 — Production knowledge base integration:
 *   - All three server-side system prompts updated with full Carewell knowledge base
 *   - Real pricing, packages, service areas, contact info, eco options, veterans guidance
 *   - Model routing unchanged: claude-opus-4-5 (immediate/planning), claude-haiku-4-5 (research)
 *   - Supabase session logging unchanged (non-blocking)
 *
