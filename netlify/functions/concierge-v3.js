 ...
 * Version: 3.0
 * CR006 — Calendly booking button integration:
 *   - All 3 server-side system prompts updated with [SHOW_BOOKING] token instruction
 *   - Claude emits [SHOW_BOOKING] at end of message when offering a consultation
 *   - Token is detected client-side in index-v8.html, stripped from display,
 *     and replaced with a styled "Book a Free Consultation" button linking to
 *     https://calendly.com/cjtester7/free-30-minute-consultation
 *   - Button renders once per session to avoid repetition
 *   - All Carewell knowledge base content unchanged from v2
 *
